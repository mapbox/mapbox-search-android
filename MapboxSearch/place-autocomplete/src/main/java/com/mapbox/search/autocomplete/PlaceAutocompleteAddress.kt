...
/**
 * Class representing address of a place returned by the [PlaceAutocomplete].
 */
@Parcelize
public class PlaceAutocompleteAddress internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PlaceAutocompleteAddress
