...
internal class CategoryIntegrationTest {
    ...
    fun setUp() {
        ...
        val engine = createCategoryApiSearchEngine(
            app = APP,
    ...
    fun testRequestParametersForNearbySearch() {
        ...
        val query = CategoryQuery.Category.COFFEE_SHOP_CAFE
        ...
        runBlocking {
            category.search(query, proximity, options)
        }
    ...
    fun testRequestParametersForSearchInRegion() {
        ...
        val query = CategoryQuery.Category.ATM
        ...
        runBlocking {
            category.search(query, region, proximity, options)
        }
    ...
    fun testRequestParametersForSearchAlongTheRoute() {
        ...
        val query = CategoryQuery.Category.GAS_STATION
        ...
        runBlocking {
            category.search(query, route, deviation, options)
        }
    ...
    fun testSuccessfulResponseToCallbacks() {
        ...
        val response = category.searchBlocking(
            CategoryQuery.Category.COFFEE_SHOP_CAFE,
            Point.fromLngLat(2.2966029609152523, 48.85993304489138)
        )
    ...
    private companion object {
        ...
        fun createCategoryApiSearchEngine(
            app: Application,
            url: String
        ...
        fun Category.searchBlocking(
            query: CategoryQuery,
            proximity: Point,
            options: CategoryOptions = CategoryOptions(),
            executor: Executor = SearchSdkMainThreadWorker.mainExecutor
        ): BlockingCompletionCallback.CompletionCallbackResult<List<CategoryResult>> {
            val callback = BlockingCompletionCallback<List<CategoryResult>>()
