...
internal fun withElevation(@DimenRes elevationIdRes: Int) = ElevationMatcher(elevationIdRes)

internal class ElevationMatcher(@DimenRes private val elevationIdRes: Int) : TypeSafeMatcher<View>() {
