...
internal object SearchResultsInflater {

    fun SearchResultsRecyclerBuilder.inflateSearchResults(mockResponseAssetName: String) {
        return when (mockResponseAssetName) {
            Constants.Assets.RANELAGH_SUGGESTIONS_ASSET -> inflateForRanelaghSuggestion()
            Constants.Assets.CATEGORY_CAFE_RESULTS_ASSET -> inflateForCafeCategory()
