...
internal class SearchEngineDataProvidersIntegrationTest : BaseTest() {
    ...
    fun testCreatedSearchEngineNoDefaultDataProviders() {
        val searchEngine = SearchEngine.createSearchEngine(apiType = ApiType.SEARCH_BOX, settings = searchEngineSettings)
    ...
    fun testCreatedSearchEngineDataProvidersIndependence() {
        val searchEngine1 = SearchEngine.createSearchEngine(apiType = ApiType.SEARCH_BOX, settings = searchEngineSettings)
        ...
        val searchEngine2 = SearchEngine.createSearchEngine(apiType = ApiType.SEARCH_BOX, settings = searchEngineSettings)
