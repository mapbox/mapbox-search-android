...
internal class OfflineSearchOptionsTest {
    ...
    @TestFactory
    fun `Check OfflineSearchOptions's equals() and hashCode()`() = TestCase {
    ...
    @TestFactory
    fun `Check OfflineSearchOptions's copy()`() = TestCase {
        Given("${OfflineSearchOptions::class.java.simpleName} class") {
            When("Call copy()") {
    ...
    @TestFactory
    fun `Check OfflineSearchOptions's toString()`() = TestCase {
        Given("${OfflineSearchOptions::class.java.simpleName} class") {
            When("Call toString()") {
